    ...
    <section className="container mx-auto my-24">
      ...
      <div className="max-w-[800px] mx-auto">
        <div className="profile-features-container flex justify-center items-center flex-wrap gap-3">
          <div className="profile-feature flex flex-col gap-2 items-center bg-base-200 w-40 rounded-xl p-3">
            <FontAwesomeIcon
          ...
          <div className="profile-feature flex flex-col gap-2 items-center bg-base-200 w-40 rounded-xl p-3">
            <FontAwesomeIcon className="text-primary text-6xl" icon={faHeart} />
        ...
        <div className="card bg-base-200 shadow-xl mx-0 md:mx-20 my-4">
